...
/**
 * PIDF controller
 * @param kP Proportional constant (slows down robot as it approaches target)
 * @param kI Integral constant (makes sure robot corrects for small errors over time and doesn't stall)
 * @param kD Derivative constant (makes sure robot doesn't change velocities too fast)
 * @param kF Feedforward constant (guesses what the output should be based on the target)
 * @param tolerance Error threshold (how close the robot should be to the target for it to be considered there)
 * @param timeToSettle Time threshold (how long the robot should be within the error threshold for it to be considered there)
 ...
 * @param antiWindupRange The range at which the integral will reset if the error is greater than this value
 */
public class PIDF {
